...
- [Pokemon Data](/pokemon/encryption) - Uses RNG for PID generation
- [Battle System](/battle-system/damage-calculation) - RNG in damage formulas
- [Wild Encounters](/overworld/wild-encounters) - Encounter rate calculations
