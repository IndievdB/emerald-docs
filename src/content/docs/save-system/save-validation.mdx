...
- [Save Blocks](/save-system/save-blocks) - Structure of saved data
- [Flash Sectors](/save-system/flash-sectors) - Physical storage layout
- [Pokemon Encryption](/pokemon/encryption) - Additional data protection layer
