...
- [Interrupts](/gba-hardware/interrupts) - VBlank interrupt handling
- [IO Registers](/gba-hardware/io-registers) - Memory-mapped register overview
- [Backgrounds](/gba-hardware/graphics/backgrounds) - Background graphics system
- [Sprites](/gba-hardware/graphics/sprites) - OAM and sprite system
