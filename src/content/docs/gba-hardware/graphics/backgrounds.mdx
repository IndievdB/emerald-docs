...
- [Palettes](/gba-hardware/graphics/palettes) - Background color management
- [Sprites](/gba-hardware/graphics/sprites) - Sprite layer interaction
- [IO Registers](/gba-hardware/io-registers) - BGxCNT register details
