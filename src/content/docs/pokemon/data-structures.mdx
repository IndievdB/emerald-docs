...
The actual stat formula is detailed in [Stats Calculation](/emerald-docs/pokemon/stats-calculation).
...
{`graph TB
    ...
    style Encrypted fill:#f9d,stroke:#333,color:#000
    style Header fill:#9df,stroke:#333,color:#000
    style Stats fill:#9fd,stroke:#333,color:#000`}
</pre>
</DiagramContainer>
...
- [Encryption System](/emerald-docs/pokemon/encryption) - How Pokemon data is encrypted
- [Species Data](/emerald-docs/pokemon/species-data) - Base stats and species information
- [Stats Calculation](/emerald-docs/pokemon/stats-calculation) - How battle stats are computed
