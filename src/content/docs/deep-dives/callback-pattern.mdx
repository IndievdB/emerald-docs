...
- [Main Loop](/emerald-docs/game-flow/main-loop) - Callback execution context
- [Task System](/emerald-docs/deep-dives/task-system) - Concurrent operations
- [State Machine](/emerald-docs/game-flow/state-machine) - State management overview
