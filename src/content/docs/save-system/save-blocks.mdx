...
- [Flash Sectors](/save-system/flash-sectors) - How save data is written to flash
- [Save Validation](/save-system/save-validation) - Checksums and corruption detection
