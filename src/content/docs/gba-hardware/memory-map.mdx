...
Hardware control registers. See [I/O Registers](/emerald-docs/gba-hardware/io-registers) for details.
...
- [I/O Registers](/emerald-docs/gba-hardware/io-registers) - Control the hardware
- [DMA](/emerald-docs/gba-hardware/dma) - Fast memory transfers
- [Graphics: Sprites](/emerald-docs/gba-hardware/graphics/sprites) - How sprite data flows
