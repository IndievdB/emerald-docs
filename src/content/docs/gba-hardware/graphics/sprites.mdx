...
- [Palettes](/emerald-docs/gba-hardware/graphics/palettes) - Sprite color management
- [Backgrounds](/emerald-docs/gba-hardware/graphics/backgrounds) - Layer interaction
- [Sprite System](/emerald-docs/deep-dives/sprite-system) - Detailed sprite engine analysis
