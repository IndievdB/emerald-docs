...
- [Script Commands](/scripting/script-commands) - How scripts display text
- [Sprite System](/deep-dives/sprite-system) - Text in sprite form
- [Backgrounds](/gba-hardware/graphics/backgrounds) - BG layer usage
