...
#define PLTT_SIZE     0x400       // 1KB total (512 colors × 2 bytes)
...
- [Backgrounds](/gba-hardware/graphics/backgrounds) - How backgrounds use palettes
- [Sprites](/gba-hardware/graphics/sprites) - How sprites use palettes
- [IO Registers](/gba-hardware/io-registers) - Display control registers
