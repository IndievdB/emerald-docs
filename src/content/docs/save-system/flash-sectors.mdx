...
- [Save Blocks](/emerald-docs/save-system/save-blocks) - RAM structures being saved
- [Save Validation](/emerald-docs/save-system/save-validation) - Checksum and integrity checking
