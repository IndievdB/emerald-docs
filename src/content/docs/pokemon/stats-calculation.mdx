...
Level is not stored directly—it's calculated from EXP:
...
- [Pokemon Data Structures](/emerald-docs/pokemon/data-structures) - Where IVs and EVs are stored
- [Species Data](/emerald-docs/pokemon/species-data) - Base stats and growth rates
