...
While the [GBA hardware](/gba-hardware/graphics/sprites) provides 128 OAM entries for sprites, Pokemon Emerald builds a comprehensive sprite engine on top with templates, animations, callbacks, and tile management. This deep dive covers the software layer.
...
- [Sprites (Hardware)](/gba-hardware/graphics/sprites) - OAM and hardware details
- [Palettes](/gba-hardware/graphics/palettes) - Sprite palette management
- [Task System](/deep-dives/task-system) - Coordinating with sprite callbacks
