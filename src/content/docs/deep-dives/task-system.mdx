...
- [Callback Pattern](/deep-dives/callback-pattern) - Higher-level state management
- [Main Loop](/game-flow/main-loop) - Where tasks execute
- [Sprite System](/deep-dives/sprite-system) - Sprite callbacks (different system)
