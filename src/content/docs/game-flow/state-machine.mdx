...
<DeepDiveLink
  href="/emerald-docs/deep-dives/callback-pattern"
...
- [GBA Hardware](/emerald-docs/gba-hardware/) - The platform underneath
- [Overworld](/emerald-docs/overworld/) - Field gameplay in detail
- [Battle System](/emerald-docs/battle/) - Combat mechanics
