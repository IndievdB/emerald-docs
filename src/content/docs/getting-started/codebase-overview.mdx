...
1. **[Game Flow](/emerald-docs/game-flow/)** - Understand the main loop in detail
2. **[GBA Hardware](/emerald-docs/gba-hardware/)** - Learn about the platform
3. **[Overworld](/emerald-docs/overworld/)** - See how field gameplay works
4. **[Battle System](/emerald-docs/battle/)** - Dive into combat mechanics
