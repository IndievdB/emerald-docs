...
- [Main Loop](/game-flow/main-loop) - How interrupts integrate with gameplay
- [DMA](/gba-hardware/dma) - DMA transfers during VBlank
- [Task System](/deep-dives/task-system) - Game logic scheduling
