...
- [DMA](/gba-hardware/dma) - DMA controller registers
- [Interrupts](/gba-hardware/interrupts) - Interrupt handling
- [Backgrounds](/gba-hardware/graphics/backgrounds) - Background system
- [Sprites](/gba-hardware/graphics/sprites) - OAM and sprite control
