...
<DeepDiveLink
  href="/emerald-docs/gba-hardware/memory-map"
...
<DeepDiveLink
  href="/emerald-docs/gba-hardware/interrupts"
  title="Interrupts"
...
<DeepDiveLink
  href="/emerald-docs/gba-hardware/io-registers"
  title="I/O Registers"
...
- [Memory Map](/emerald-docs/gba-hardware/memory-map) - How memory is organized and used
- [I/O Registers](/emerald-docs/gba-hardware/io-registers) - Hardware control registers
- [Interrupts](/emerald-docs/gba-hardware/interrupts) - Event handling
- [DMA](/emerald-docs/gba-hardware/dma) - Fast memory transfers
- [Graphics: Backgrounds](/emerald-docs/gba-hardware/graphics/backgrounds) - Tile-based backgrounds
- [Graphics: Sprites](/emerald-docs/gba-hardware/graphics/sprites) - Object rendering
- [Graphics: Palettes](/emerald-docs/gba-hardware/graphics/palettes) - Color management
